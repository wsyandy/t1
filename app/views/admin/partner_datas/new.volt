<form method="POST" class="simple_form new_partner_data ajax_model_form" data-model="partner_data"
      action="/admin/partner_datas/create" accept-charset="UTF-8" id="new_partner_data" novalidate="novalidate">
    ...
    <div class="form-group string optional partner_data_settlement_num"
        ...
        <div><input type="text" class="  input optional form-control" id="partner_data_settlement_num"
                    name="partner_data[settlement_num]" value="">
        </div>
    </div>
    ...
    <div class="form-group string optional partner_data_start_at"
        ...
        <div><input type="text" class=" form_datetime input optional form-control" id="partner_data_start_at"
                    name="partner_data[start_at]" value="{{ start_at }}">
        </div>
    </div>
