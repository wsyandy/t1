...
<script type="text/template" id="activity_tpl">
    <tr id="activity_${activity.id}">
        ...
        <td><a class="modal_action" href="/admin/activities/platforms?id=${activity.id}">查看(${ activity.platform_num })</a></td>
        <td><a class="modal_action" href="/admin/activities/product_channel_ids?id=${activity.id}">查看(${ activity.product_channel_num })</a></td>
