...
{% macro music_link(complaint) %}
    <a href="/admin/musics?music[id_eq]={{ complaint.music_id }}">{{ complaint.music_name }}</a>
{% endmacro %}

{{ simple_table(complaints, [
'ID': 'id', '时间': 'created_at_text', '举报人':'complainer_link','被举报人': 'respondent_link',
'房间': 'room_link','歌曲':'music_link','举报类型': 'complaint_type_text',
'状态': 'status_text'
]
) }}
