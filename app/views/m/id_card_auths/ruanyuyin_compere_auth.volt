{{ block_begin('head') }}
{{ theme_css( '/m/ruanyuyin/css/main','/m/ruanyuyin/css/compere_auth') }}
{{ block_end() }}

<div class="vueBox" id="app">

    <div class="compere_edit">
        <ul>
            <li>
                <span>真实姓名 </span>
        ...
        <div :class="['compere_btn',{'compere_agree':!hasAgree}]" @click="submit()">
            <span>确认提交 </span>
        </div>

        <div class="compere_tips">
            <div class="compere_tips_title">【${tips.tit}】</div>
            <ul>
...
<script>
    var opts = {
        data: {
            ...
            isSet: false,
            selected: 0,
            readonly: '{{ current_user.id_card_auth == 1 or current_user.id_card_auth == 3 }}',
            options: {{ banks }},
            gift_orders: [],
            sid: '{{ sid }}',
            code: '{{ code }}',
            ...
            hasAgree: true,
            set_select: '/m/ruanyuyin/images/ico-select.png',
        },
        watch: {
            receive: function () {
                vm.gift_orders = [];
        ...
        methods: {
            ...
            agreeSelect: function () {
                console.log(vm.hasAgree);
                if (vm.hasAgree) {
                    vm.hasAgree = false;
                    vm.set_select = '/m/ruanyuyin/images/ico-selected.png';
                } else {
                    vm.hasAgree = true;
                    vm.set_select = '/m/ruanyuyin/images/ico-select.png';
                }
            },
            agreement: function () {
