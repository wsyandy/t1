    ...
    <div v-if="isrulesToast" class="wishing_rules_toast">
        <div class="wishing_rules_scroll">
            <ul>
                ...
                <li><span class="dot"></span> 活动期间后台将每天不定时抽取5名参与者送豪礼，直至活动结束，抽到的幸运儿将有机会获得价值3000元的表（1块），共三款靓表供您选择</li>
                ...
                <li><span class="dot"></span> 活动开始时间5.13零点开始至6.17二十四点止；中奖用户请联系客服QQ：3407150190</li>
