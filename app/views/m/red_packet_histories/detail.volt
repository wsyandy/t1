...
<div id="app">
    ...
    <div class="detail_get">
        <span>已领取{{ red_packet['balance_num'] ?  red_packet['balance_num'] : 0 }}/{{ red_packet['num'] }}</span>
        <span>共{{ red_packet['balance_diamond'] ? red_packet['balance_diamond'] : 0}}／{{ red_packet['diamond'] }}钻</span>
    </div>
