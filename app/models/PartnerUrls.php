...
class PartnerUrls extends BaseModel
{
    ...
    static $TYPE = ['gdt' => '广点通', 'toutiao' => '头条', 'uc' => '阿里汇川UC', 'wx_gdt' => '微信广告', 'momo' => '陌陌', 'baidu' => '百度', 'sina' => '新浪','jp'=>'巨朋','xztx'=>'行者天下','xc'=>'星辰'];
    ...
    static $PARTNER_PARMS = [
        ...
        'ios_xc' => '/sources/xc_click?code=%s&fr=%s&appid={appid}&idfa={idfa}&callback={callbackurl}'
    ];
