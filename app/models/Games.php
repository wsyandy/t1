...
class Games extends BaseModel
{
    ...
    function generateGameClientUrl($current_user, $room, $game_history_id)
    {
        ...
        $client_url = $this->url . '?sid=' . $current_user->sid . '&code=' . $current_user->product_channel->code . '&game_id=' . $this->id .
            ...
            '&avater_url=' . $current_user->avatar_url . '&user_num_limit=8&site=' . $site . '&owner=' . $owner . '&game_history_id=' . $game_history_id;
