    ...
    static function createHistory($activity_id, $opts = [])
    {
        ...
        if ($activity_history->save()) {
            ...
            if (in_array($prize_type, [2, 4])) {
                ...
                $tmp = ['remark' => "活动" . $activity_history->activity->title . "奖励" . $gold . "金币", 'target_id' => $activity_id];
                GoldHistories::changeBalance($user_id, GOLD_TYPE_ACTIVITY_LUCKY_DRAW, $gold, $tmp);
