...
class ProductChannelsController extends BaseController
{
    ...
    function bootConfigAction()
    {
        ...
        if (isDevelopmentEnv()) {
            ...
            $detail_json['menu_config'][] = ['show' => true, 'title' => '许愿墙', 'url' => '/m/wish_histories', 'icon' => $root . 'images/test.png'];
            $detail_json['menu_config'][] = ['show' => true, 'title' => '测试分享系统', 'url' => '/m/distribute', 'icon' => $root . 'images/test.png'];
        } else {
        ...
        $detail_json['menu_config'][] = ['show' => true, 'title' => '活动', 'url' => '/m/activities', 'icon' => $root . 'images/menu_activity_2.png'];
        $detail_json['menu_config'][] = ['show' => true, 'title' => '家族', 'url' => '/m/unions', 'icon' => $root . 'images/menu_union_2.png'];
