...
> http-post ```/api/group_chats/close_user_chat```
##### 14.1 请求参数说明
|参数|参数名称|类型|是否可空|备注
|---|---|---|---|---
|id|群聊id|int|否||
...
> http-post ```/api/group_chats/open_user_chat```
##### 15.1 请求参数说明
|参数|参数名称|类型|是否可空|备注
|---|---|---|---|---
|id|群聊id|int|否||
...
> http-post ```/api/group_chats/entrance_group_chat```
##### 16.1 请求参数说明
|参数|参数名称|类型|是否可空|备注
|---|---|---|---|---
|id|群聊id|int|否|||
