...
注：
扬声器控制：使用用户基本信息里speaker字段；

话筒控制：由用户角色，用户microphone和麦位microphone字段控制，
用户是旁听角色，话筒关闭；
用户是房主角色，判断用户microphone字段；
用户是主播角色，先判断麦位microphone字段，再判断用户microphone字段；

角色：0不在房间，1房主，2主播，3旁听；
